window.characterData = {
    ...
    "Yin": {
        ...
        "nombre": "Yin",
        "raza": "Elfo",
        "clase": "Pícaro (Asesino del Trueno)",
        "nivel": 4,
        "fondo": "Eremita",
        ...
        "rasgos": [
            {
                "nombre": "🗡️ Ataque Furtivo (+2d6)",
                "desc": "1/Turno. Si tienes Ventaja O aliado a 5ft del objetivo. Daño extra."
            },
            {
                "nombre": "☠️ Asesinar (Forzar Críticos)",
                "desc": "Ventaja vs enemigos que no han actuado. <strong>Crítico Automático</strong> si están sorprendidos."
            },
            {
                "nombre": "⚡ Katana Dios Trueno (Objeto)",
                "desc": "1d10 cort (ignora resis).<br><strong>Danza Tormenta (Bonus, 4/día):</strong> +20ft vel, +1 ataque extra este turno."
            },
            {
                "nombre": "🔥 Daga de Fuego (Objeto)",
                "desc": "1d12 fuego. Crítico desmiembra. Cauteriza."
            },
            {
                "nombre": "👻 Capa Espectral (Objeto)",
                "desc": "CA 15+DES. Ventaja Sigilo. Invisible en oscuridad.<br><strong>Cargas (3/largo, Reacción):</strong><br>1. +1d8 radiante al golpear.<br>2. +2 CA al ser golpeado.<br>3. Cegar (CON 13) atacante."
            },
            {
                "nombre": "⚡ Desenvainar (1/Largo, Bonus)",
                "desc": "Duración 3 turnos. +1d8 Trueno a ataques. <strong>Marca</strong> objetivos con electricidad estática (acumulable)."
            },
            {
                "nombre": "⚡ Envainar (1/Largo, Bonus)",
                "desc": "Detona marcas. <strong>Daño:</strong> 1d8 trueno por cada marca acumulada en cada enemigo golpeado previamente."
            },
            {
                "nombre": "🌪️ Tornado (1/Largo, Acción)",
                "desc": "Línea 20x5ft. DEX Save. <strong>Fallo:</strong> 2d8 daño + Salen Volando (1 turno). (Aplica furtivo si no han actuado)."
            },
            {
                "nombre": "🌪️ Combo Aéreo (Bonus tras Tornado)",
                "desc": "TP encima de los que vuelan. Ataque a TODOS en el aire con Ventaja y Crítico garantizado."
            },
            {
                "nombre": "🩸 Asesino en Serie",
                "desc": "Si matas a alguien, obtienes una acción de ataque extra instantánea."
            },
            {
                "nombre": "👢 Botas Rápidas",
                "desc": "Paso Brumoso 2/día."
            }
        ],
        "conjuros": [
            {
                "nombre": "Paso Brumoso",
                "nivel": 2,
                "desc": "Teleport 30ft (2/día Botas)."
            },
            {
                "nombre": "Reacción: Cegar",
                "nivel": "Esp",
                "desc": "Capa: CON 13 o Ciego 1 turno."
            },
            {
                "nombre": "Reacción: Escudo Lunar",
                "nivel": "Esp",
                "desc": "Capa: +2 CA contra un ataque."
            },
            {
                "nombre": "Reacción: Golpe Lunar",
                "nivel": "Esp",
                "desc": "Capa: +1d8 radiante al daño."
            }
        ]
    }
};